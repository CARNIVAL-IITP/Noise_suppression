...
class trainer:
    def __init__(self, args):
        ...
        self.output_path = args.output_path+'%s_%s_%s_50'%(self.model_name, self.dataset, self.loss_name)
    ...
    def init_model(self, model_name, model_options):
        model = nn.DCCRN_mimo(use_clstm=True)
        wandb.watch(model)
    ...
    def train(self, epoch):
        ...
        for i, data in enumerate(self.train_loader):
            ...
            loss, loss_snr, WPE = self.loss_fn(out_wav, label, est_phase, specs_t)
